function [y,x,x0] = send_refsignal(nrep,Fs,nchan,ID)
...
% ID: device ID of the recording device (found using 'findInDevID.m')
%  
% Output:
...
r = audiorecorder(Fs, 16, nchan, ID);
